...
async def run(*, ingest_all: bool, limit: int | None) -> None:
...
def main() -> None:
    ...
    parser.add_argument(
        ...
        type=int,
        default=None,
        help="Maximum number of IDs to ingest in this run",
    )
    args = parser.parse_args()
    asyncio.run(run(ingest_all=args.ingest_all, limit=args.limit))
